    ...
    const boardConfig = {
        ...
        taskLists: [
            ...
            },
            {
                ...
                tasks: [
                    {
                        name: 'Create Trello Ui clone',
                        due: new Date( 2019, 11, 20 )
                    },
                    {
                        name: 'Create user login page',
                        due: new Date( 2019, 11, 18 )
                    }
                ]
            },
            {
                name: 'Practise Javascript',
                tasks: [
                    {
                        name: 'JSON array object list',
                        due: new Date( 2019, 11, 18 )
                    }
                ]
            },
